...
| `GEMINI_THINKING_BUDGET` | — (provider default: `0`) | Thinking-token budget per Gemini call; `0` disables model thinking (faster, cheaper), raise for deeper semantic analysis |
