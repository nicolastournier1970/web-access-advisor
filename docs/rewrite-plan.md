...
- [ ] Phase 6 — Auth v2 gate *(running)*: engine-level e2e against the fixture login site — record with marked segment (credentials never persisted), replay pause → failed premature continue → sign-in → resume, storageState reuse skips the pause.
